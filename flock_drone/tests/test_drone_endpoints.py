...
class TestDroneRequests(unittest.TestCase):
    ...
    def test_request_vocab(self):
        ...
        request_put = requests.put(DRONE_URL + 'api/vocab', data=json.dumps(dict(foo='bar')))
        request_post = requests.post(DRONE_URL + 'api/vocab', data=json.dumps(dict(foo='bar')))
    ...
    def test_request_entrypoint(self):
        ...
        request_put = requests.put(DRONE_URL + 'api/', data=json.dumps(dict(foo='bar')))
        request_post = requests.post(DRONE_URL + 'api/', data=json.dumps(dict(foo='bar')))
    ...
    def test_request_drone(self):
        ...
        request_put = requests.put(DRONE_URL + 'api/Drone', data=json.dumps(get_drone_default()))
        request_post = requests.post(DRONE_URL + 'api/Drone', data=json.dumps(get_drone_default()))
    ...
    def test_request_datastream(self):
        ...
        request_put = requests.put(DRONE_URL + 'api/Datastream', data=json.dumps(datastream))
    ...
    def test_request_command_collection(self):
        ...
        request_post = requests.post(DRONE_URL + 'api/CommandCollection', data=json.dumps(command))
